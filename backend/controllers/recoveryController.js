...
exports.verifyVisualPassword = asyncHandler(async (req, res) => sendSuccess(res, 200, { recovery: await recoveryService.verifyVisualPassword({ recoveryId: req.body.recoveryId, verificationPayload: req.body.verificationPayload }) }));
exports.createPasskey = asyncHandler(async (req, res) => sendSuccess(res, 200, { recovery: await recoveryService.createPasskey(req.body) }));
